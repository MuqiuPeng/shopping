        ...
        <div className="bg-card border border-border rounded-2xl shadow-xl p-8 backdrop-blur-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">
              Join Pearl & Crystal for exclusive jewelry collections and
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start space-x-3">
              <input
                ...
                type="checkbox"
                required
                className="mt-1 h-4 w-4 rounded border border-input text-primary focus:ring-2 focus:ring-ring focus:ring-offset-2"
              />
              <label
                htmlFor="terms"
                className="text-sm text-muted-foreground leading-relaxed"
              >
                I agree to Pearl & Crystal's{" "}
                <a
                  href="#"
