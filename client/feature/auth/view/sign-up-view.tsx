...
export const metadata: Metadata = {
  title: "Create Account - Diamond Bracelet Collection",
  description:
    "Join our exclusive community to access premium diamond bracelet collections.",
};
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-secondary/10 to-accent/5 flex items-center justify-center px-4 py-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-32 right-20 w-32 h-32 bg-accent/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-16 w-24 h-24 bg-primary/5 rounded-full blur-2xl"></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-accent/10 rounded-full blur-xl"></div>
      </div>
        ...
        <div className="text-center mb-8 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground max-w-sm mx-auto leading-relaxed">
              Create your account to explore our exclusive diamond bracelet
              collection and enjoy premium benefits
            </p>
          </div>
        </div>
